...
class CreateUpdateWorkoutView extends StatefulWidget {
  ...
  @override
  _CreateUpdateWorkoutViewState createState() => _CreateUpdateWorkoutViewState();
}
...
class _CreateUpdateWorkoutViewState extends State<CreateUpdateWorkoutView> {
  ...
  void initState() {
    ...
    selectedExercises = List<int>.from(widget.workout?.exercises ?? []);
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(widget.workout == null ? 'Create Workout' : 'Update Workout'),
      ),
      body: Consumer(
            ...
            child: Column(
              ...
              children: [
                ...
                TextField(
                  ...
                  decoration: const InputDecoration(labelText: 'Workout Description'),
                  maxLines: 3,
                ),
                const SizedBox(height: 16),
                ...
                ElevatedButton(
                  ...
                  child: Text(widget.workout == null ? 'Save Workout' : 'Update Workout'),
                ),
              ],
            ),
          );
